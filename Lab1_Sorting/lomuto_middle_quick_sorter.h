...
#ifndef LAB1_SORTING__LOMUTO_MIDDLE_QUICK_SORTER_H_
#define LAB1_SORTING__LOMUTO_MIDDLE_QUICK_SORTER_H_

#include "sorter.h"
class LomutoMiddleQuickSorter : public Sorter {
 public:
 ...
 private:
  ...
  int LomutoMiddlePartition(int *v, int no_elements, Operation *op_comp, Operation *op_assign);
...
#endif //LAB1_SORTING__LOMUTO_MIDDLE_QUICK_SORTER_H_
